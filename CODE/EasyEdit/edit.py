...
def test_DPO_llama():
    ...
    # Load hyperparameters and select the appropriate editor
    hparams = DPOHyperParams.from_hparams('./hparams/DPO/llama3-8b.yaml')  # Example uses ROME parameters
    editor = BaseEditor.from_hparams(hparams)

    # Execute edit, passing locality and portability inputs
    metrics, edited_model, _ = editor.edit(
        prompts=prompts,
        rephrase_prompts=rephrase_prompts,
        target_new=target_new,
