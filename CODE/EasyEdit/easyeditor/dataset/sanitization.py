...
class SanitizationTrainDataset(Dataset):
    ...
    def __init__(
        ...
        data_dir: str,
        template: str, 
        specify_answers: str=None,         # If specified, only the specified answer is visible each time, others are not
        ...
        **kwargs
        ...
        if specify_answers is not None:
            # Indicates not processing all, but only taking specific ones
            ...
            data["K_F"] = tmp
            # Take K_R
            # For example, if idx is 1, theoretically it should be [80:160]
