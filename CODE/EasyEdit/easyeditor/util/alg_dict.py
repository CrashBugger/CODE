...
from ..models.causaledit import CausalEditHyperParams, apply_causaledit_to_model

def apply_pre_edited_to_model(model, *args,**kargs):
    return model, {}
...
ALG_DICT = {
    ...
    "CausalEdit": apply_causaledit_to_model,
    "PreEdited": apply_pre_edited_to_model,
}
